...
require_once 'includes/send_approval_email.php'; // for sending approval email
                    ...
                    <div class="doc-list">
                        ...
                        <div class="doc-item">
                            <div class="doc-info">
                                ...
                                <a href="<?= htmlspecialchars($doc['file_path']) ?>" target="_blank" class="btn-download">📎 Download</a>
                            </div>
