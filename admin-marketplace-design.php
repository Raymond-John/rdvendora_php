        ...
        if (isset($_FILES['hero_image']) && $_FILES['hero_image']['error'] === UPLOAD_ERR_OK) {
            ...
            if (in_array($ext, $allowed) && $_FILES['hero_image']['size'] < 2*1024*1024) {
                ...
                if (move_uploaded_file($_FILES['hero_image']['tmp_name'], $destination)) {
                    updateSetting('hero_image', $destination);
                }
            }
        }
            ...
            <div class="settings-group-body">
                <form method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <?php if ($hero_image): ?>
                            <div style="margin-top: 10px;"><img src="<?= htmlspecialchars($hero_image) ?>" style="max-width: 150px; border-radius: 8px;"></div>
                        <?php endif; ?>
                    </div>
                    <div class="form-group">
                ...
                <div class="hero-preview">
                    ...
                    <?php if ($hero_image): ?>
                        <img src="<?= htmlspecialchars($hero_image) ?>" alt="Banner preview">
                    <?php else: ?>
