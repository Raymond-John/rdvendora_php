<?php
if (!isset($googleOauth) || !is_array($googleOauth)) {
    $googleOauth = function_exists('rdv_google_oauth_config')
...
?>
        ...
        <a href="<?= htmlspecialchars($googleBtnHref, ENT_QUOTES, 'UTF-8') ?>" class="btn btn-google" target="_top" rel="noopener">
