...
<div id="preloader">
  ...
  <div class="pre-content">
    ...
    <div class="pre-steps">
      <div class="pre-step active" id="step1"><i class="fas fa-check-circle"></i> Loading products</div>
      <div class="pre-step" id="step2"><i class="fas fa-check-circle"></i> Setting up store</div>
