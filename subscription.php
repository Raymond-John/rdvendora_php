        ...
        <div class="sidebar-footer">
            <div class="sidebar-user">
                ...
                <div class="sidebar-user-info">
                    ...
                    <div class="sidebar-user-role"><?= htmlspecialchars($_SESSION['store_name'] ?? 'No Store') ?></div>
                </div>
            </div>
        </div>
    </aside>
        ...
        <header class="topbar">
            ...
            <div class="topbar-actions">
                ...
                <div class="dropdown" id="userDropdown">
                    <div class="topbar-user dropdown-trigger"><img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100" class="topbar-user-avatar"><div class="topbar-user-info"><span class="topbar-user-name"><?= htmlspecialchars($_SESSION['fullname']) ?></span><span class="topbar-user-role"><?= htmlspecialchars($_SESSION['store_name'] ?? 'No Store') ?></span></div><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" style="color:var(--text-muted);"><polyline points="6 9 12 15 18 9"/></svg></div>
